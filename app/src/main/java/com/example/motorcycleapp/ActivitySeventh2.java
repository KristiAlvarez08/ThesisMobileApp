...
public class ActivitySeventh2 extends AppCompatActivity {
    ...
    private int counter=5,flag=0, registeredPassRecoveryAttempts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registeredPassRecoveryAttempts = database.getInt("passRecoveryAttempts",5);

        System.out.println("pin attempt:" + registeredPassRecoveryAttempts);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((registeredRecoveryCode.equals(recoveryCodeValue)) ){
                    ...
                    registeredPassRecoveryAttempts--;
                    editor.putInt("passRecoveryAttempts",registeredPassRecoveryAttempts);
                    editor.apply();

                    if(registeredPassRecoveryAttempts == 0){
                        nextBtn.setEnabled(false);
                        isCounter = false;
                    ...
                    Toast.makeText(ActivitySeventh2.this, "Invalid recovery code! "+registeredPassRecoveryAttempts+" number attempts remaining", Toast.LENGTH_SHORT).show();
                }
