...
public class ActivityFourthV2 extends AppCompatActivity {
    ...
    private int flag=0, registeredPinNumberAttempts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registeredPinNumberAttempts = database.getInt("pinNumAttempts",5);

        System.out.println("pin attempt:" + registeredPinNumberAttempts);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((registeredPinNumber.equals(pinNumberValue)) ){
                    pinNumber.setText("");
                    openActivityFifthV2();
                } else if ( pinNumberValue.length() != 4) {
                    Toast.makeText(ActivityFourthV2.this, "Invalid! PIN has 4 numbers", Toast.LENGTH_SHORT).show();
                } else {
                    registeredPinNumberAttempts--;
                    editor.putInt("pinNumAttempts",registeredPinNumberAttempts);
                    editor.apply();

                    if(registeredPinNumberAttempts == 0){
                        nextButton.setEnabled(false);
                        isCounter = false;
                    ...
                    Toast.makeText(ActivityFourthV2.this, "Invalid pin number! "+registeredPinNumberAttempts+" attempts remaining", Toast.LENGTH_SHORT).show();
                }
