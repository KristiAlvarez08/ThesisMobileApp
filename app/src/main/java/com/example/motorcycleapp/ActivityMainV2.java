...
public class ActivityMainV2 extends AppCompatActivity {
    ...
    private int counter=5,registeredLogInAttempts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registeredLogInAttempts = database.getInt("logInAttempts",5);
        System.out.println("pin attempt:" + registeredLogInAttempts);
        ...
        if(bleStat.equals("off")) {
            ...
            builder.setMessage("You have unpaired the immobilizer. Your account has been removed by the system. Please register again.");
            ...
            loginButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if((usernameValue.equals(registeredUsername)) && (passwordValue.equals(registeredPassword)) ){
                        ...
                        registeredLogInAttempts --;
                        editor.putInt("logInAttempts",registeredLogInAttempts);
                        editor.apply();

                        if(registeredLogInAttempts ==0){
                            loginButton.setEnabled(false);
                            isCounter = false;
                        ...
                        Toast.makeText(ActivityMainV2.this, "Invalid username and password! "+registeredLogInAttempts+" attempts remaining", Toast.LENGTH_SHORT).show();
                    }
