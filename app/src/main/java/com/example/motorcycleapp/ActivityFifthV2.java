    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                openActivityFifthV2(); //if ma disconnected from gatt server, e refresh ang screen para konek balik
    ...
    public class manualChangeKeyCodeThread extends Thread {
        ...
        public void run() {
            while (!exitThread2) {
                ...
                System.out.println("RSA ENCRYPT LENGTH:"+ rsa_cipher_encrypt.length);
...
//                        System.out.println("MESSAGE" + message );
    ...
    protected void onRestart() {
        ...
        System.out.println("NAA KON ONRESTART");
        bgAppStatus=1;
        System.out.println("BG STATUS:" + bgAppStatus);
        ...
        isResume = false;
	    mBluetoothLeService.close();
        System.out.println("BLE is closed");
        openScreen4();
    }
